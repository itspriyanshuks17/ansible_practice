...
- Ansible commands reference: [ANSIBLE_COMMANDS.md](ANSIBLE_COMMANDS.md)
...
5. Learn the main CLI commands in [ANSIBLE_COMMANDS.md](ANSIBLE_COMMANDS.md).
6. Create and update your inventory in [hosts.ini](hosts.ini) using your worker private IPs.
...
8. Run your first playbook from the examples in [ANSIBLE_NOTES.md](ANSIBLE_NOTES.md).
